...
class RectangleObstacle(object):
    def __init__(self, image_size, top_left, bottom_right):
        ...
        self.rect = pygame.Rect(image_size * self.tl[0], image_size * self.tl[1],
                                image_size * (self.br[0] - self.tl[0]), image_size * (self.br[1] - self.tl[1]))

    def draw(self, screen, color):
        ims = self.image_size
        pygame.draw.rect(screen, color, (
        ims * self.tl[0], ims * self.tl[1], ims * (self.br[0] - self.tl[0]), ims * (self.br[1] - self.tl[1])))
